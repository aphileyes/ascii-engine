...
namespace Engine {
    ...
    Engine::Engine()
        : entity_manager_(std::make_unique<Entity::EntityManager>()), input_receiver_(std::make_unique<IO::InputReceiver>()), actor_controller_(std::make_unique<System::ActorController>()), canvas_(std::make_unique<System::Canvas>()), renderer_(std::make_unique<Graphics::Renderer>(50, 30)) {}
    ...
    void Engine::GameLoop() {
        ...
        entity_manager_->AddComponent<Component::Sprite>(actor, std::make_shared<Component::Sprite>('*'));
        entity_manager_->AddComponent<Component::Health>(actor, std::make_shared<Component::Health>(1.0f));
